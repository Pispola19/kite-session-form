 ...
 * Generata da Horizon Registry UX (Anora). Non è Registry runtime, non è L3,
 * non è tubo B. Niente id, niente fetch, niente vento.
 */
(function initNuovaUxEquipmentFaceSlice(global) {
  ...
  "MODELS_BY_BRAND": {
    ...
    "Forcekiteandwake": [
      ...
      "Lift Electric Lesson Demo",
      "North Echo Pro",
      "North Scoop",
      "Slingshot Dwarf Craft V4",
      "Slingshot WF 2 V6 44"
    ],
    "Free": [
      "Core"
    ],
